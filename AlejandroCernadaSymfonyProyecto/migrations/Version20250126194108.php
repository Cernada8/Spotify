 ...
 */
final class Version20250126194108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE perfil (id INT AUTO_INCREMENT NOT NULL, estilo_musical_preferido_id INT DEFAULT NULL, fofoto VARCHAR(255) NOT NULL, descripcion VARCHAR(255) NOT NULL, INDEX IDX_966576471C9C8804 (estilo_musical_preferido_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
